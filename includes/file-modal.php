...
<div class="bg-modal hidden" id="file-modal">
    ...
    <form id="newItemForm" action="../file-process.php" method="POST">
            ...
            <div style="display: flex; align-items: center; width: 90%; justify-content: center;margin: auto;"><span class="bigtext">New Text file <?php echo $title;?></span><img src="/policy-code/images/file.png" style="margin: 20px 0px 20px 20px; width: 45px;">
            </div>
