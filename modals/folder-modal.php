<div class="bg-modal hidden" id="folder-modal">
    <div class="modal-content">
        <form id="newFolderForm" action="./.policy-code/api/folder-process.php" method="POST">
            ...
            <div style="display: flex; align-items: center; width: 90%; justify-content: center;margin: auto;"><span id="new-folder-title" class="bigtext">New Folder
                    <?php echo $_User; ?>
            ...
            <div class="upload-button-container">
                <input type="hidden" name="currentDir" value="<?php echo $target; ?>">
